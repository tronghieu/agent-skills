...
| [brainstorm-coach](#brainstorm-coach) | Tạo ra những ý tưởng thật cho một cái tên, một chiến dịch, một tính năng, hay bất kỳ điều gì bạn đang bí — ý tưởng của bạn luôn đi trước, AI chỉ bồi thêm chứ không giành lấy. |
...
Một người bạn đồng hành brainstorm luôn để ý tưởng của bạn đi trước: mỗi lượt bạn nói trước và ý tưởng được ghi lại nguyên văn, sau đó AI mới thêm ý tưởng của riêng nó, luôn được đánh dấu rõ ràng — không bao giờ diễn đạt lại hay thay thế điều bạn nói, và không bao giờ phán xét ý tưởng trong lúc bạn còn đang tạo ra chúng.

**README của skill:** [brainstorm-coach](./skills/brainstorm-coach/README.vi.md)

**Bạn nhận được gì:**
- Vòng lặp commit-first: ý tưởng của bạn được ghi lại trước tiên và nguyên văn, gắn nhãn (user)/(AI) rõ ràng, không phán xét trong lúc phát triển ý tưởng — ngay cả phản biện cũng được biến thành câu hỏi chứ không phải lời phán quyết, cho đến vòng phê bình có cấu trúc riêng về sau
- Một kho khoảng 20 kỹ thuật có tên riêng (SCAMPER, Sáu Chiếc Mũ Tư Duy, đảo ngược vấn đề, tư duy loại suy, question storming, đóng vai, "nếu như", và nhiều hơn nữa), được nhóm theo kiểu tư duy phù hợp, agent luôn giải thích vì sao chọn kỹ thuật đó
- Một vòng cung đầy đủ mở rộng→thu hẹp: tạo ý tưởng tự do, rồi gom nhóm và xếp hạng có lý do, kết thúc bằng Ngay lập tức/Tương lai/Cú đánh liều lớn/Bài học
- **Party mode:** một hội đồng nhỏ tùy chọn gồm các góc nhìn theo vai (bên liên quan, người vận hành, người ngoài cuộc, người khiêu khích) bồi thêm trên ý tưởng của bạn và trả lời bằng một bản tóm tắt duy nhất, mỗi góc nhìn được ghi nhãn rõ ràng, thay vì một loạt tiếng nói dồn dập
- Chuyển giao đúng lúc sang các skill khác trong gia đình — problem-solver, design-thinking, market-researcher, strategy-board, critical-thinking
