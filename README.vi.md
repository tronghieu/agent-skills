...
|---|---|
| [brainstorm-coach](#brainstorm-coach) | Giúp bạn nghĩ ra ý tưởng thật cho một cái tên, chiến dịch, tính năng mới, hay bất cứ điều gì bạn đang bí ý tưởng — bạn luôn nói trước, AI chỉ góp thêm ý của nó sau, không giành lời của bạn. |
| [critical-thinking](#critical-thinking) | Kiểm tra một đề xuất, báo cáo hoặc lập luận có dựa trên bằng chứng vững chắc hay không; phát hiện giả định yếu trước khi chúng dẫn đến quyết định tốn kém. |
| [cv-scorer](#cv-scorer) | So sánh ứng viên công bằng với yêu cầu công việc, chỉ ra người phù hợp nhất và những điểm cần xem xét kỹ hơn. |
| [data-scientist](#data-scientist) | Biến dữ liệu thành câu trả lời đáng tin: giải thích điều gì đã thay đổi, kiểm tra kết quả có ý nghĩa không và nêu rõ đánh đổi của từng khuyến nghị. |
| [deep-reader](#deep-reader) | Đọc kỹ sách và tài liệu dài, tạo ghi chú rõ ràng cùng bản tóm tắt đáng tin để dùng cho các câu hỏi về sau. |
| [design-thinking](#design-thinking) | Hiểu nhu cầu thực của người dùng, biến nghiên cứu thành insight hữu ích và thử nghiệm giải pháp trước khi đầu tư nhiều nguồn lực. |
| [diataxis-writer](#diataxis-writer) | Làm tài liệu hướng dẫn, kho kiến thức và bài giải thích dễ theo dõi hơn, để người đọc nhận đúng thông tin vào đúng lúc. |
| [fiction-studio](#fiction-studio) | Phát triển câu chuyện từ ý tưởng ban đầu đến bản thảo hoàn chỉnh, với hỗ trợ riêng cho cốt truyện, nhân vật, bối cảnh, hội thoại và biên tập. |
| [market-researcher](#market-researcher) | Đánh giá cơ hội bằng thông tin có nguồn: quy mô thị trường, đối thủ, tín hiệu nhu cầu và xu hướng, để nhìn nhận ý tưởng kinh doanh tự tin hơn. |
| [problem-solver](#problem-solver) | Giúp bạn tìm đúng nguyên nhân của một vấn đề trước khi vội sửa — đặt câu hỏi đúng, kiểm tra giả định rẻ nhất trước, và ghi lại quá trình để lần sau mở lại làm tiếp. |
| [product-manager](#product-manager) | Quyết định nên làm gì tiếp theo, biến ý tưởng thành kế hoạch rõ ràng, học từ phản hồi khách hàng và chuẩn bị ra mắt với ít bất ngờ hơn. |
| [project-manager](#project-manager) | Đưa dự án từ kế hoạch đến bàn giao bằng tiến độ thực tế, rủi ro minh bạch, trách nhiệm rõ ràng và báo cáo trung thực. |
| [slidewright](#slidewright) | Tạo slide thuyết trình hấp dẫn, dễ nhìn từ cuối phòng và giúp người nói truyền đạt thông điệp rõ ràng hơn. |
| [socratic-questor](#socratic-questor) | Học sâu qua những câu hỏi gợi mở, giúp bạn tự xây dựng sự hiểu biết thay vì chỉ nhận một đáp án có sẵn. |
| [strategy-board](#strategy-board) | Xem xét một quyết định kinh doanh lớn từ nhiều góc nhìn chuyên môn: cơ hội, cạnh tranh, tài chính, thực thi và rủi ro. |
| [system-prompt-creator](#system-prompt-creator) | Xác định cách một trợ lý AI cần hoạt động, để nó đưa ra phản hồi nhất quán và hữu ích hơn cho một công việc cụ thể. |

## Tìm Hiểu Từng Skill

### brainstorm-coach

Một người bạn đồng hành giúp bạn brainstorm: bạn luôn là người nói ý tưởng ra trước. AI sẽ ghi lại nguyên văn những gì bạn nói, không sửa lại câu chữ, rồi mới góp thêm ý của riêng nó — và luôn nói rõ đâu là ý của bạn, đâu là ý của AI. Trong lúc cả hai còn đang nghĩ ý tưởng, sẽ không có ai chê hay đánh giá gì cả, để bạn thoải mái nói ra bất cứ điều gì nghĩ trong đầu.

**README của skill:** [brainstorm-coach](./skills/brainstorm-coach/README.vi.md)

**Bạn nhận được gì:**
- Bạn luôn nói ý tưởng trước, AI ghi lại đúng y nguyên rồi mới góp ý riêng của mình, có ghi rõ ý nào là của bạn, ý nào là của AI — ngay cả khi AI không đồng ý với một ý tưởng, nó cũng chỉ hỏi lại chứ không phán xét, để bạn không ngại nói ra ý tiếp theo
- Một kho khoảng 20 cách brainstorm khác nhau (như SCAMPER — thử thay đổi từng phần của ý tưởng, Sáu Chiếc Mũ Tư Duy — nhìn vấn đề từ nhiều góc khác nhau, đảo ngược vấn đề, đóng vai, và nhiều cách khác), AI chọn cách phù hợp và giải thích vì sao chọn nó
- Một buổi làm việc trọn vẹn: bắt đầu nghĩ thật rộng, rồi dần dần thu hẹp lại — gom các ý giống nhau, xếp hạng có lý do rõ ràng — và kết thúc với danh sách những gì có thể làm ngay, việc để dành sau, ý tưởng táo bạo đáng giữ lại, và bài học rút ra
- **Party mode:** mời thêm vài góc nhìn khác vào cuộc trò chuyện (như khách hàng, người vận hành, người ngoài cuộc, người hay phản biện) để góp ý cho ý tưởng của bạn, trả lời gọn trong một bản tóm tắt có ghi rõ từng góc nhìn, thay vì nói dồn dập
- Khi cần, sẽ nhường lời cho các skill khác trong cùng nhóm — problem-solver, design-thinking, market-researcher, strategy-board, critical-thinking
...
Một người bạn đồng hành giải quyết vấn đề theo từng bước: trước khi gợi ý bất kỳ cách sửa nào, nó giúp bạn xác định rõ chuyện gì đang thực sự xảy ra, loại bỏ những lời giải thích sai, và xác nhận đúng nguyên nhân — bằng những câu hỏi đơn giản và những cách kiểm tra ít tốn kém, thay vì một lời đoán nghe có vẻ chắc chắn.

**README của skill:** [problem-solver](./skills/problem-solver/README.vi.md)

**Bạn nhận được gì:**
- Không bao giờ bịa ra sự thật về tình huống của bạn — bất cứ điều gì nó xem là đúng đều phải đến từ bạn, còn lại sẽ được ghi rõ là "vẫn chỉ là một phỏng đoán", để bạn luôn biết cái gì đã chắc chắn và cái gì chưa
- Chọn cách đào sâu phù hợp tùy theo hình dạng vấn đề — hỏi "tại sao" liên tiếp cho một triệu chứng rõ ràng, nhìn rộng ra nhiều nguyên nhân có thể khi chưa thấy chuỗi rõ ràng, hoặc xem kỹ các kiểu lặp lại khi vấn đề cứ quay lại dù đã thử đủ cách
- Giữ nhiều hơn một cách giải thích trên bàn cho đến khi có một phép kiểm tra thật sự phân định được, thay vì chốt ngay vào lời đoán đầu tiên nghe có vẻ hợp lý
- Đi qua cả quy trình từng bước một — hiểu vấn đề, khoanh vùng, tìm nguyên nhân, nghĩ ra cách sửa, chọn cách tốt nhất, và lên kế hoạch triển khai — luôn hỏi ý kiến bạn trước khi qua bước tiếp theo, rồi mời **brainstorm-coach** vào để nghĩ ý tưởng sửa thật sự đa dạng khi nguyên nhân đã được xác nhận
- Nhớ bạn đã dừng ở đâu, nên nếu một lần kiểm tra cần thời gian thực tế (như chạy thử nhỏ hoặc theo dõi dữ liệu một tuần), bạn có thể quay lại sau và tiếp tục đúng chỗ đã dừng
